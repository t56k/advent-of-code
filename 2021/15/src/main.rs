...
fn part_one(input: &str) -> i16 {
    ...
    *risk
        .get(&((grid.len() - 1) as i16, (grid[0].len() - 1) as i16))
        .unwrap() as i16
}
...
fn part_two(input: &str) -> i16 {
    ...
    *risk
        .get(&((5 * grid.len() - 1) as i16, (5 * grid[0].len() - 1) as i16))
        .unwrap() as i16
}

pub fn main() {
    let graph = include_str!("../input");
...
2311944581";
    ...
    #[test]
    fn part_two_example() {
        let graph = "11637517422274862853338597396444961841755517295286
